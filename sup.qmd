...
######### Data Preparation #########
data_url <- "https://raw.githubusercontent.com/santi-rios/China-Chemical-Dominance/refs/heads/main/data/fig_supplements_filtered.csv"
# data_url <- "./data/fig_supplements_filtered.csv"

df <- fread(data_url) %>% 
  mutate(Country = as.factor(Country), source = as.factor(source)) %>%
  filter(source != c("FigureS-2", "FigureS-4_organoMetallicKW", "FigureS-5", "FigureS-6", "FigureS-7a_b"))
